...
##updated by ivsh-bitz to get updated link for cli on mintergate
###variables
...
wget -P $MINERGATEDIR/ https://minergate.com/download/xfast-ubuntu-cli
dpkg -i $MINERGATEDIR/xfast-ubuntu-cli
rm $MINERGATEDIR/xfast-ubuntu-cli
